...
@section('content')
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card mt-3">
                    <div class="card-header">Editar Cliente - {{ $cliente->apellidos . ", " . $cliente->nombres }}</div>
                                    ...
                                    <form action="{{ route('clientes.update', $cliente->id)  }}" method="POST">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-6">
                                                ...
                                                <input type="text" class="form-control @error('apellidos') border border-danger @enderror" id="apellidos" name="apellidos" value="{{ old('apellidos', $cliente->apellidos)  }}">
                                                @error('apellidos')
                                            ...
                                            <div class="form-group col-6">
                                                ...
                                                <input type="text" class="form-control @error('nombres') border border-danger @enderror" id="nombres" name="nombres" value="{{ old('nombres', $cliente->nombres) }}">
                                                @error('nombres')
                                                <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-6">
                                                ...
                                                <input type="text" class="form-control @error('cuit') border border-danger @enderror" id="cuit" name="cuit" value="{{ old('cuit', $cliente->cuit) }}">
                                                @error('cuit')
                                                <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
                                            <div class="form-group col-6">
                                                ...
                                                <input type="text" class="form-control @error('direccion') border border-danger @enderror" id="direccion" name="direccion" value="{{ old('direccion', $cliente->direccion) }}">
                                                @error('direccion')
                                                <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group col-6">
                                                ...
                                                <select class="form-control @error('ciudad_id') border border-danger @enderror" id="ciudad" name="ciudad_id">
                                                    ...
                                                    @foreach($ciudades as $index => $ciudad)
                                                        <option value="{{ $index }}" {{ old('ciudad_id', $cliente->ciudad_id) == $index ? 'selected' : '' }}>{{ $ciudad }}</option>
                                                    @endforeach
                                                </select>
                                                @error('ciudad_id')
                                                <small class="text-danger">{{ $message }}</small>
                                            ...
                                            <div class="form-group col-6">
                                                ...
                                                <select class="form-control @error('servicio_id') border border-danger @enderror" id="servicio" name="servicio_id">
                                                    ...
                                                    @foreach($servicios as $index => $servicio)
                                                        <option value="{{ $index }}" {{ old('servicio_id', $cliente->servicio_id) == $index ? 'selected' : '' }}>{{ $servicio }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group col-6">
                                                ...
                                                <select class="form-control" id="estado-servicio" name="estado_servicio">
                                                    <option value="0" {{ old('estado_servicio', $cliente->estado_servicio) == 0 ? 'selected' : '' }}>No Activo</option>
                                                    <option value="1" {{ old('estado_servicio', $cliente->estado_servicio) == 1 ? 'selected' : '' }}>Activo</option>
                                                </select>
                                            </div>
                                        </div>
...
@section('script')
    <script>
        $("document").ready(function (){
            ...
            if (ciudad !== '') {
                getBarrios(ciudad, {{ @old('barrio_id', $cliente->barrio_id) }})
            }
